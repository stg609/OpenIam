...
{
    public class IamPersistedGrantDbContext :
        PersistedGrantDbContext<IamPersistedGrantDbContext>, IUnitOfWork
    {
        /// <summary>
        /// 锁超时时间，单位：秒
        /// </summary>
        ...
        public IamPersistedGrantDbContext(DbContextOptions<IamPersistedGrantDbContext> options,
